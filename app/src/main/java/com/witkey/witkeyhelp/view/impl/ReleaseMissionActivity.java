...
public class ReleaseMissionActivity extends BaseListActivity {
    ...
    // private ReleaseFragment rb4fragment;
    ...
    protected void initWidget() {
        ...
        tvBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                msgIntent.putExtra(HomeActivity.KEY_MESSAGE, "type");
                LocalBroadcastManager.getInstance(ReleaseMissionActivity.this).sendBroadcast(msgIntent);
                finish();

            }
        });

     //   Button button = (Button) findViewById(R.id.btn_my);
      //  remind(button);
