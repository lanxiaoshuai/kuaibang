...
import com.witkey.witkeyhelp.view.impl.ConversationListController;
...
public class ConversationListFragment extends BaseMessageFragment {
    ...
    private static final int PULUPREFRESH = 0x3003;
...
//        }
        ...
        mRootView = layoutInflater.inflate(R.layout.fragment_conv_list,
                (ViewGroup) getActivity().findViewById(R.id.container), false);

//        mRootView = layoutInflater.inflate(R.layout.fragment_conv_list,
//                (ViewGroup) getActivity().findViewById(R.id.container), false);
//
//        mRootView.findViewById(R.id.news_list_view);
    ...
    public void onEvent(MessageEvent event) {
        ...
        if (msg.getTargetType() == ConversationType.group) {
            ...
            if (conv != null && mConvListController != null) {
                if (msg.isAtMe()) {
                    MyAPP.isAtMe.put(groupId, true);
                    mConvListController.getAdapter().putAtConv(conv, msg.getId());
                }
                if (msg.isAtAll()) {
                    MyAPP.isAtall.put(groupId, true);
        ...
        public void handleMessage(android.os.Message msg) {
            ...
            switch (msg.what) {
                case REFRESH_CONVERSATION_LIST:
                    ...
                    if(  mConvListController.getAdapter()!=null){
