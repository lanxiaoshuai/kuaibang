...
public class DynamicFragmentAdapter extends FragmentStatePagerAdapter {
    ...
    List<CicleBean.ReturnObjectBean.RowsBean> selectLst;

    public DynamicFragmentAdapter(FragmentManager fm, List<Fragment> list,    List<CicleBean.ReturnObjectBean.RowsBean> selectLst) {
        super(fm);
