...
public class PublishDialog extends Dialog {
    ...
    private void goinDia() {
        ...
        //首先把发布回收评估三个控件设置为不可见
        mPublishMainRlmian.setAnimation(AnimationUtils.loadAnimation(mContext,R.anim.post_task));
        //然后设置主布局的动画
...
//        },100);
     ...
     */
    public void outDia(){
        mPublishMainRlmian.setAnimation(AnimationUtils.loadAnimation(mContext,R.anim.exit_task_release));
