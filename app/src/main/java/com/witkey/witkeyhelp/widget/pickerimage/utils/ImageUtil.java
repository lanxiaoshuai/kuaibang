package com.witkey.witkeyhelp.widget.pickerimage.utils;
...
public class ImageUtil {
    ...
    public static Bitmap getDefaultBitmapWhenGetFail() {
        try {
            return getBitmapImmutableCopy(MyAPP.getInstance().getResources(), R.drawable.image_download_failed);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public static int[] getBoundWithLength(int maxSide, Object imageObject, boolean resizeToDefault) {
        ...
        if (String.class.isInstance(imageObject)) {
            ...
            bound = BitmapDecoder.decodeBound(MyAPP.getInstance().getResources(), (Integer) imageObject);
            width = bound[0];
            height = bound[1];
    ...
    public static Bitmap getBitmapFromDrawableRes(int res) {
        try {
            return getBitmapImmutableCopy(MyAPP.getInstance().getResources(), res);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
