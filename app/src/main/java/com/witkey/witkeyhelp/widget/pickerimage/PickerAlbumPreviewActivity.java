...
import com.witkey.witkeyhelp.widget.imagepicker.view.ViewPagerFixed;
import com.witkey.witkeyhelp.widget.pickerimage.adapter.PickerPreviewPagerAdapter;
...
import com.witkey.witkeyhelp.widget.pickerimage.utils.BitmapDecoder;
import com.witkey.witkeyhelp.widget.pickerimage.utils.Extras;
import com.witkey.witkeyhelp.widget.pickerimage.utils.ImageUtil;
import com.witkey.witkeyhelp.widget.pickerimage.utils.PickerUtil;
import com.witkey.witkeyhelp.widget.pickerimage.utils.RequestCode;
import com.witkey.witkeyhelp.widget.pickerimage.view.BaseZoomableImageView;
...
public class PickerAlbumPreviewActivity extends UIView implements OnClickListener, OnPageChangeListener {
    ...
    private void setTitleIndex(int index) {
        if (totalSize <= 0) {
            include_title.setText("");
        } else {
            index++;
            include_title.setText(index + "/" + totalSize);
        }
    }
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.picker_image_preview_photos_select) {
            ...
            if (selectPhotoList != null && selectPhotoList.size() == 0) {
                ...
                ToastUtils.showTestShort(PickerAlbumPreviewActivity.this, "请至少选择一张发送");
            } else {
