...
public class RoundImageViewTwo extends android.support.v7.widget.AppCompatImageView {
    ...
    public RoundImageViewTwo(Context context, AttributeSet attrs, int defStyleAttr) {
